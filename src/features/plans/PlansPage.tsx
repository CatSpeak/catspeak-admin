...
const PlansPage: React.FC = () => {
  ...
  const { plans, stats, loading, error, filters, setFilters, refetch } = usePlans();
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage, create and configure service plans on the system</p>
        </div>

        <div className="flex items-center gap-2">
          <Button variant="primary" size="sm" onClick={() => navigate('/plans/create')}>
