  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="fixed right-4 left-4 mt-4.25 flex h-120 flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-lg sm:left-auto sm:w-90.25 lg:absolute lg:right-0 lg:top-auto"
      >
