// ==========================================
// Voucher Management System - Type Definitions & API Schemas
// ==========================================
...
export type VoucherStats = VoucherStatsDto

// --- Voucher List Item & Responses (VoucherListResponse) ---
...
export type GetVouchersResponse = VoucherListResponse

// --- Voucher Detail (VoucherDetailDto) ---
...
export type VoucherDetail = VoucherDetailDto

// --- Usages History (VoucherUsageListResponse) ---
...
export type GetVoucherUsagesResponse = VoucherUsageListResponse

// --- Generate Code Response (GenerateCodeResponse) ---

export interface GenerateCodeResponse {
  code: string
}

export type GenerateVoucherCodeResponse = GenerateCodeResponse

// --- Class Vouchers Response (ClassVouchersResponse) ---

export interface ClassVoucherItem extends VoucherListItem {
  isApplicable?: boolean
  inapplicableReason?: string | null
  discountCalculated?: number | null
}

export interface ClassVouchersResponse {
  applicableVouchers: ClassVoucherItem[]
  inapplicableVouchers?: ClassVoucherItem[]
  bestVoucher?: ClassVoucherItem | null
  classId?: number
  orderAmount?: number
...
export interface GetClassVouchersParams {
  learnersCount?: number
  orderAmount?: number
}
