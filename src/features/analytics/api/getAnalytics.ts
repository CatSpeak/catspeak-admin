...
export const getExistingUsers = async (
  dateRange: DateRange,
): Promise<ExistingUsersResponse> => {
  return fetchWithDefaultParams<ExistingUsersResponse>(
    "existing-users",
    dateRange,
  );
};
...
export const getUserClassification = async (
  ...
  return fetchWithDefaultParams<UserClassificationResponse>(
    "user-classification",
    dateRange,
  );
};
...
export const getActivityBreakdown = async (
  ...
  return fetchWithDefaultParams<ActivityBreakdownResponse>(
    "activity-breakdown",
    dateRange,
  );
};
