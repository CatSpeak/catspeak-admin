const vi = {
  ...
  broadcast: {
    ...
    roleUser: "Học viên / User Thường (Role ID 1)",
    roleInstructor: "Giảng viên / Instructor (Role ID 2)",
    filterByCountry: "Lọc Theo Quốc Gia (Country)",
    importEmailList: "Import Danh Sách Email (CSV / Text)",
    uploadCsvExcel: "Tải Tệp CSV / Excel Lên",
